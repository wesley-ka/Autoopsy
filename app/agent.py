...
class LLMAgent:
    ...
    def diagnose_logs(self, service_status: dict, cloudflare_deployments: list, logs: str, cloudflare_stages: list = None) -> str:
        ...
        system_prompt = (
            ...
            "or due to deployment configuration errors. Provide a clear, structured Markdown diagnosis report that is "
...
"""
    ...
    def respond_to_query(self, user_message: str, service_status: dict, cloudflare_deployments: list, logs: str, metrics: dict, cloudflare_stages: list = None, history: list = None) -> dict:
        ...
        system_prompt = (
            ...
            "If the action is 'chat', formulate a friendly, concise, and highly professional Markdown SRE report answering their specific query "
            "using the provided live system context. For example, if they ask about traffic or errors, look at the logs/metrics. If they ask about the frontend, look at the Cloudflare deployments and the detailed build stages.\n\n"
